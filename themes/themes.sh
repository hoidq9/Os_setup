...
themes() {
	...
	cd $REPO_DIR
	sudo cp intel-processor.jpg intel-core-i9.jpg /usr/share/backgrounds
	gsettings set org.gnome.desktop.background picture-uri 'file:///usr/share/backgrounds/intel-core-i9.jpg'
}
